...
function create_event() {
  ...
  function get_data() {
    ...
    const initial_hour = document.getElementById('initial_date_form').value;
    ...
    const max_participants = document.getElementById('max_participants_from').value;
    const location = document.getElementById('loc_from').value;
